...
fn blend4_reg_add_alpha() {
    ...
    let feyn_raw = crate::common::load_test_image("feyn-word.tif").expect("load feyn-word.tif");
    let feyn = feyn_raw.convert_to_8().expect("feyn to 8bpp");
    let weasel_raw =
        crate::common::load_test_image("weasel4.16c.png").expect("load weasel4.16c.png");
    let weasel = weasel_raw.convert_to_32().expect("weasel to 32bpp");
    let karen = crate::common::load_test_image("karen8.jpg").expect("load karen8.jpg");
...
fn blend4_reg_gray_mask_blend() {
    ...
    let fish = crate::common::load_test_image("fish24.jpg").expect("load fish24.jpg");
    let wyom = crate::common::load_test_image("wyom.jpg").expect("load wyom.jpg");
