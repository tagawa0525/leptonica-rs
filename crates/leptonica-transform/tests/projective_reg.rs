...
/// Test invertability of sampling (`pixProjectiveSampledPta`) — i=0..2
///
...
fn projective_reg_sampling_invertability() {
    ...
    // C: pixs = pixRead("feyn.tif"); pixsc = pixScale(pixs, 0.3, 0.3);
    ...
    for i in 0..3 {
        ...
        // C: pix1 = pixProjectiveSampledPta(pixb, ptad, ptas, L_BRING_IN_WHITE);
...
/// Test invertability of grayscale interpolation (`pixProjectivePta`) — i=0..1
///
...
fn projective_reg_grayscale_interpolation_invertability() {
    ...
    let added_border = 125u32; // C: ADDED_BORDER_PIXELS / 2
    ...
    for i in 0..2 {
        ...
        // C: pix1 = pixProjectivePta(pixb, ptad, ptas, L_BRING_IN_WHITE);
        let pix1 =
...
/// Comparison between sampling and interpolated (point set 3)
///
