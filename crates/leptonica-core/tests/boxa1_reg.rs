...
//!
//! C版: reference/leptonica/prog/boxa1_reg.c
//! Box作成、Boxa構築、領域比較、変換、表示をテスト。
//!
//! NOTE: C版のboxaCompareRegions, boxaTransform, boxaExtractCorners,
//! boxaShiftWithPta, シリアライズI/OはRust未実装のためスキップ。
...
fn boxa1_reg() {
    ...
    // --- Test 6: Box translate (equivalent to C boxaTransform with shift) ---
    ...
    // NOTE: C版テスト7 (boxaShiftWithPta) はRust未実装
    // NOTE: C版テスト8 (serialized I/O) はRust未実装
