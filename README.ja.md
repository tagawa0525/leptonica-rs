...
C版の182ソースファイル・2,743関数 (`allheaders.h` 集計) に対する移植の進捗。

| 指標                 | 数値                                                                                                    |
| -------------------- | ------------------------------------------------------------------------------------------------------- |
| コード行数           | 約147,000行 / 249,000行                                                                                 |
| 関数カバレッジ       | 2,023 / 2,834 (71.4%)                                                                                   |
| 実カバレッジ         | 2,023 / 2,150 (94.1%)                                                                                   |
| 回帰テストカバレッジ | 159 / 159 (100.0%)                                                                                      |
| C pixel-level 互換   | Ok 44 / Mismatch 29 / MissingC 0 / Unmapped 447 / Excluded 53 ([詳細](docs/porting/c-compat-status.md)) |

詳細: [機能比較](docs/porting/feature-comparison.md) / [テスト比較](docs/porting/test-comparison.md) / [C互換ベースライン](docs/porting/c-compat-status.md)
