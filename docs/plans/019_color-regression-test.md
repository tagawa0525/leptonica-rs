...
| --------------- | ------------------ | --------- | ------ | ----- |
| `blend1_reg.rs` | `gray_straight`    | `blended` | Png    | 8bpp  |
|                 | `gray_inverse`     | `blended` | Png    | 8bpp  |
|                 | `adapt`            | `blended` | Png    | 8bpp  |
|                 | `color`            | `blended` | Png    | 32bpp |
...
| `blend5_reg.rs` | `snap_white`      | `snapped`        | Png    | Pix (変換不要)    |
|                 | `snap_black`      | `snapped`        | Png    | Pix (変換不要)    |
|                 | `snap_custom`     | `snapped`        | Png    | Pix (変換不要)    |
|                 | `fade_left`       | PixMut `.into()` | Png    | PixMut→Pix 変換要 |
|                 | `fade_top`        | PixMut `.into()` | Png    | PixMut→Pix 変換要 |
