...
| 142      | F. compare_tiles_by_histo (1)         | 1    | IMPLEMENTED | TBD                                   |
| 143      | F. pix_compare_gray_by_histo (1)      | 1    | IMPLEMENTED | TBD                                   |
| 144      | F. photo-histo chain (4)              | 4    | IMPLEMENTED | TBD                                   |
...
| 140      | D. FPix affine + projective (2)       | 2    | IMPLEMENTED | TBD                                   |
| 141      | D. pix_component_function (1)         | 1    | IMPLEMENTED | TBD                                   |
| 110b     | D. FPix Pta wrappers                  | 2    | 🚫 再分類   | slope_border 依存; coeff 版を直接使用 |
...
| 139      | E. Ptaa get_boundary_pixels (1)       | 1    | IMPLEMENTED | TBD                                   |
| 111b     | E. pixPlotAlongPta                    | 1    | 🚫 再分類   | gplot 依存; plotters 等で代替         |
