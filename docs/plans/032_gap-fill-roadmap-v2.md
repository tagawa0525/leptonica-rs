...
| -------- | --------------------- | ---- | ------- | -- |
| 501      | G. カーネル生成       | 5    | PLANNED | -  |
| 113      | H. arrayaccess        | 4    | PLANNED | -  |
| 112      | F. 画像比較           | 11   | PLANNED | -  |
| 803      | C. 文書解析 + K. Skew | 12   | PLANNED | -  |
| 106      | A-1. Pixa 選択        | 12   | PLANNED | -  |
| 110      | D. FPix 拡張          | 12   | PLANNED | -  |
| 109      | B. Numa 高度          | 23   | PLANNED | -  |
| 107      | A-2. Pixa 変換        | 14   | PLANNED | -  |
| 114      | I. RGB スケーリング   | 5    | PLANNED | -  |
| 108      | A-3. Pixa プロパティ  | 24   | PLANNED | -  |
| 111      | E. Pta + graphics     | 15   | PLANNED | -  |
| 116      | L. Numa 基本          | 5    | PLANNED | -  |
| 115      | J. graphics ヘルパー  | 3    | PLANNED | -  |
| (個別)   | M. 単独               | 6    | PLANNED | -  |
...
- C 版の API シグネチャをそのまま移植せず、Rust idiomatic な API に再設計する
  ことを推奨 (Pix→Pix の owned 戻り値、`Result` でエラー伝播、等)
- 各サブ計画の着手前に reference/leptonica/ で C 版実装を確認し、
  外部依存 (libc, libtiff 等) が無いことを確認する
