...
| 状態        |    件数 | 説明                                                                                                                                                                          |
| ----------- | ------: | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ✅ Ok       | **440** | C 版と pixel-level 完全一致 (Phase 2.5 で +10、Phase 3 で +12、plan 902 で +396)                                                                                              |
...
合計 958 entries がレポート対象 (As of 2026-08-22、plan 902 PR 41 後)。
Rust manifest (`tests/golden_manifest.tsv`) 全体は **965 entries** (コメント 2 行を除く)。
