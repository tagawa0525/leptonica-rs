...
| 状態        |    件数 | 説明                                                                                                                                                                          |
| ----------- | ------: | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ✅ Ok       | **268** | C 版と pixel-level 完全一致 (Phase 2.5 で +10、Phase 3 で +12、plan 902 で +224)                                                                                              |
...
合計 786 entries がレポート対象 (As of 2026-08-18、plan 902 PR 30 後)。
Rust manifest (`tests/golden_manifest.tsv`) 全体は **793 entries**。
