...
| 状態        | 件数    | 説明                                                                                                                              |
| ----------- | ------: | --------------------------------------------------------------------------------------------------------------------------------- |
| ✅ Ok       | **166** | C 版と pixel-level 完全一致 (Phase 2.5 で +10、Phase 3 で +12、plan 902 で +122)                                                  |
...
合計 678 entries がレポート対象 (As of 2026-08-16、plan 902 PR 18 後)。
Rust manifest (`tests/golden_manifest.tsv`) 全体は **685 entries**。
