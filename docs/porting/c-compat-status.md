...
| 状態        |    件数 | 説明                                                                                                                                                                          |
| ----------- | ------: | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ✅ Ok       | **415** | C 版と pixel-level 完全一致 (Phase 2.5 で +10、Phase 3 で +12、plan 902 で +371)                                                                                              |
...
合計 933 entries がレポート対象 (As of 2026-08-20、plan 902 PR 39 後)。
Rust manifest (`tests/golden_manifest.tsv`) 全体は **940 entries**。
