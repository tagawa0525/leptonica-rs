...
| 状態        |    件数 | 説明                                                                                                                                                                          |
| ----------- | ------: | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ✅ Ok       | **278** | C 版と pixel-level 完全一致 (Phase 2.5 で +10、Phase 3 で +12、plan 902 で +234)                                                                                              |
...
合計 796 entries がレポート対象 (As of 2026-08-18、plan 902 PR 31 後)。
Rust manifest (`tests/golden_manifest.tsv`) 全体は **803 entries**。
