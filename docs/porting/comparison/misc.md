...
| pixAddBorder | ❌ 未実装 | - | 境界追加 |
| pixAddBorderGeneral | ❌ 未実装 | - | 汎用境界追加 |
| pixAddBlackOrWhiteBorder | ❌ 未実装 | - | 白黒境界追加 |
| pixAddMirroredBorder | ❌ 未実装 | - | ミラー境界追加 |
| pixRemoveBorder | ❌ 未実装 | - | 境界除去 |
| pixRemoveBorderGeneral | ❌ 未実装 | - | 汎用境界除去 |
| pixRemoveBorderToSize | ❌ 未実装 | - | 指定サイズまで境界除去 |
| pixSetText | ❌ 未実装 | - | テキスト設定 |
| pixAddText | ❌ 未実装 | - | テキスト追加 |
| pixSetTextCompNew | ❌ 未実装 | - | 圧縮テキスト設定 |
