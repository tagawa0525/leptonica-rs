...
**カバレッジ**: 28.9% (154/532 関数が実装済み、🚫 不要 314 関数を除くと実質 154/218 = 70.6% 実装)
...
| C関数                     | 状態 | Rust対応 | 備考                                   |
| ------------------------- | ---- | -------- | -------------------------------------- |
| bbufferDestroyAndSaveData | 🚫   | -        | L_ByteBuffer は Rust の Vec<u8> で代替 |
| bbufferExtendArray        | 🚫   | -        | L_ByteBuffer は Rust の Vec<u8> で代替 |
...
| C関数          | 状態 | Rust対応 | 備考                              |
| -------------- | ---- | -------- | --------------------------------- |
| l_asetGetFirst | 🚫   | -        | L_Aset は Rust の BTreeSet で代替 |
| l_asetGetLast  | 🚫   | -        | L_Aset は Rust の BTreeSet で代替 |
| l_asetGetNext  | 🚫   | -        | L_Aset は Rust の BTreeSet で代替 |
| l_asetGetPrev  | 🚫   | -        | L_Aset は Rust の BTreeSet で代替 |
| l_asetSize     | 🚫   | -        | L_Aset は Rust の BTreeSet で代替 |
...
| C関数                | 状態 | Rust対応 | 備考 |
| -------------------- | ---- | -------- | ---- |
| rotateorthFilesToPdf | ❌   | -        |      |

### ptafunc2.c (追加分)

| C関数                 | 状態 | Rust対応      | 備考                              |
| --------------------- | ---- | ------------- | --------------------------------- |
| l_asetCreateFromPta   | 🚫   | -             | L_Aset は Rust の BTreeSet で代替 |
| l_hmapCreateFromPta   | ❌   | -             |                                   |
...
| ptaUnionByAset        | ❌   | -             |                                   |
| ptaUnionByHmap        | ❌   | -             |                                   |
| ptaaSortByIndex       | ✅   | sort_by_index | core/box_/sort.rs                 |

### rbtree.c (追加分)

| C関数            | 状態 | Rust対応 | 備考                                |
| ---------------- | ---- | -------- | ----------------------------------- |
| l_rbtreeDelete   | 🚫   | -        | L_Rbtree は Rust の BTreeMap で代替 |
| l_rbtreeGetCount | 🚫   | -        | L_Rbtree は Rust の BTreeMap で代替 |
| l_rbtreeGetLast  | 🚫   | -        | L_Rbtree は Rust の BTreeMap で代替 |
| l_rbtreeGetPrev  | 🚫   | -        | L_Rbtree は Rust の BTreeMap で代替 |
| l_rbtreeInsert   | 🚫   | -        | L_Rbtree は Rust の BTreeMap で代替 |
| l_rbtreeLookup   | 🚫   | -        | L_Rbtree は Rust の BTreeMap で代替 |
| l_rbtreePrint    | 🚫   | -        | L_Rbtree は Rust の BTreeMap で代替 |
...
| C関数                         | 状態 | Rust対応                        | 備考                |
| ----------------------------- | ---- | ------------------------------- | ------------------- |
| pixFindHorizontalRuns         | ✅   | find_horizontal_runs            | filter/runlength.rs |
| pixFindMaxHorizontalRunOnLine | ✅   | find_max_horizontal_run_on_line | filter/runlength.rs |
| pixFindMaxRuns                | ✅   | find_max_runs                   | filter/runlength.rs |
| pixFindMaxVerticalRunOnLine   | ✅   | find_max_vertical_run_on_line   | filter/runlength.rs |
| pixFindVerticalRuns           | ✅   | find_vertical_runs              | filter/runlength.rs |
...
| C関数                    | 状態 | Rust対応          | 備考                              |
| ------------------------ | ---- | ----------------- | --------------------------------- |
| l_asetCreateFromSarray   | 🚫   | -                 | L_Aset は Rust の BTreeSet で代替 |
| l_hmapCreateFromSarray   | ❌   | -                 |                                   |
| sarrayGenerateIntegers   | ✅   | generate_integers | core/sarray/mod.rs                |
...
| C関数                  | 状態 | Rust対応 | 備考            |
| ---------------------- | ---- | -------- | --------------- |
| l_getStructStrFromFile | 🚫   | -        | Rust 標準で代替 |
...
| C関数                    | 状態 | Rust対応 | 備考                                            |
| ------------------------ | ---- | -------- | ----------------------------------------------- |
| convertGrayCodeToInt     | 🚫   | -        | Gray code 変換 (Rust では別途実装可能)          |
| convertIntToGrayCode     | 🚫   | -        | Gray code 変換 (Rust では別途実装可能)          |
| convertOnBigEnd16        | 🚫   | -        | Rust 標準ライブラリ (i32::swap_bytes 等) で代替 |
| convertOnBigEnd32        | 🚫   | -        | Rust 標準ライブラリ (i32::swap_bytes 等) で代替 |
| convertOnLittleEnd16     | 🚫   | -        | Rust 標準ライブラリ (i32::swap_bytes 等) で代替 |
| convertOnLittleEnd32     | 🚫   | -        | Rust 標準ライブラリ (i32::swap_bytes 等) で代替 |
...
| l_getCurrentTime         | 🚫   | -        | Rust 標準で代替                                 |
| l_getFormattedDate       | 🚫   | -        | Rust 標準で代替                                 |
| l_hashFloat64ToUint64    | 🚫   | -        | L_Hashmap は Rust の HashMap で代替             |
| l_hashPtToUint64         | 🚫   | -        | L_Hashmap は Rust の HashMap で代替             |
| l_hashStringToUint64     | 🚫   | -        | L_Hashmap は Rust の HashMap で代替             |
| l_hashStringToUint64Fast | 🚫   | -        | L_Hashmap は Rust の HashMap で代替             |
| lept_ceiling             | ❌   | -        |                                                 |
| lept_floor               | ❌   | -        |                                                 |
| lept_isPrime             | ❌   | -        |                                                 |
| lept_roundftoi           | ❌   | -        |                                                 |
...
| startWallTimer           | 🚫   | -        | デバッグ/タイミング系                           |
| stopTimer                | 🚫   | -        | デバッグ/タイミング系                           |
| stopTimerNested          | 🚫   | -        | デバッグ/タイミング系                           |
| stopWallTimer            | 🚫   | -        | デバッグ/タイミング系                           |
...
| arrayFindEachSequence     | 🚫   | -        | 配列ヘルパー (Rust 標準で代替)     |
| arrayFindSequence         | 🚫   | -        | 配列ヘルパー (Rust 標準で代替)     |
| arrayReplaceEachSequence  | 🚫   | -        | 配列ヘルパー (Rust 標準で代替)     |
