...
| [leptonica (src/morph/)](comparison/morph.md) | 82 | 16 | 10 | 21 | 129 | 76.0% | 90.7% |
| [leptonica (src/filter/)](comparison/filter.md) | 82 | 0 | 6 | 11 | 99 | 82.8% | 93.2% |
...
| [leptonica (src/recog/)](comparison/recog.md) | 94 | 26 | 28 | 14 | 162 | 74.1% | 81.1% |
| [その他](comparison/misc.md) | 11 | 0 | 78 | 94 | 183 | 6.0% | 12.4% |
| **合計** | **1,058** | **127** | **489** | **341** | **2,015** | **58.8%** | **70.8%** |
...
| leptonica (src/morph/) | ~9,400 | 98/129 (76.0%) | 98/108 (90.7%) | 二値/グレースケール/カラー形態学, DWA, 細線化 |
| leptonica (src/filter/) | ~9,800 | 82/99 (82.8%) | 82/88 (93.2%) | 畳み込み, エッジ検出, バイラテラル, ランク, 適応マッピング |
...
| leptonica (src/recog/) | ~16,000 | 120/162 (74.1%) | 120/148 (81.1%) | スキュー補正, デワーピング, 文字認識, バーコード |
| その他 | - | 11/183 (6.0%) | 11/89 (12.4%) | ワーパー, エンコーディング |
| **合計** | **~119,500** | **1,185/2,015 (58.8%)** | **1,185/1,674 (70.8%)** | |

## 未実装の主要領域（❌ 489関数）

341関数は🚫不要と分類済み。残りの❌未実装489関数の内訳:
...
### leptonica (src/recog/)（❌ 28関数）

- **ページセグメンテーション**: テーブル検出等の高度な機能
...
- [leptonica (src/morph/)](comparison/morph.md) — 129関数（🚫21不要）
- [leptonica (src/filter/)](comparison/filter.md) — 99関数（🚫11不要）
- [leptonica (src/color/)](comparison/color.md) — 126関数（🚫13不要）
- [leptonica (src/region/)](comparison/region.md) — 95関数（🚫22不要）
- [leptonica (src/recog/)](comparison/recog.md) — 162関数（🚫14不要）
- [その他](comparison/misc.md) — 183関数（🚫94不要）
