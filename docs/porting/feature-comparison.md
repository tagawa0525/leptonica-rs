...
| ----------------------------------------------------- | --------- | --------- | --------- | ------- | --------- | ---------- | ------------ |
| [leptonica (src/core/)](comparison/core.md)           | 852       | 93        | 124       | 146     | 1,215     | 77.7%      | 88.4%        |
...
| **合計**                                              | **1,777** | **231**   | **142**   | **684** | **2,834** | **70.9%**  | **93.4%**    |
...
| -------------------------- | ------------ | ----------------------- | ----------------------- | ------------------------------------------------------------------------------------ |
| leptonica (src/core/)      | ~47,100      | 945/1,215 (77.7%)       | 945/1,069 (88.4%)       | Pix, Box, Pta, Ptaa, Pixaa, Colormap, 演算, 比較, ブレンド, 描画, 統計, ヒストグラム |
...
| **合計**                   | **~147,000** | **2,008/2,834 (70.9%)** | **2,008/2,150 (93.4%)** |                                                                                      |

## 未実装関数の状況

🚫 不要と分類された 684 関数を除く 2,150 関数のうち 2,008 関数が実装済み（✅ 1,777 + 🔄 231）。
残り 142 関数（❌）は未実装。実カバレッジは 93.4%。
