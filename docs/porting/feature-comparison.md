...
| -------- | ---- | ------------- | -------- |
| leptonica-core | ~47,100 | 545/882 (61.8%) | Pix, Box, Pta, Colormap, 演算, 比較, ブレンド, 描画, 統計, ヒストグラム |
| leptonica-io | ~7,900 | 85/146 (58.2%) | BMP/PNG/JPEG/PNM/TIFF/GIF/WebP/JP2K/PDF/PS/SPIX + ヘッダー読み取り |
| leptonica-transform | ~11,200 | 91/152 (59.9%) | 回転, スケーリング, アフィン, 射影, シアー |
| leptonica-morph | ~9,400 | 98/120 (81.7%) | 二値/グレースケール/カラー形態学, DWA, 細線化 |
| leptonica-filter | ~9,800 | 82/99 (82.8%) | 畳み込み, エッジ検出, バイラテラル, ランク, 適応マッピング |
| leptonica-color | ~7,400 | 68/126 (54.0%) | 色空間変換, 量子化, セグメンテーション, 二値化, 色分析 |
| leptonica-region | ~10,600 | 48/95 (50.5%) | 連結成分, シードフィル, 分水嶺, 四分木, 迷路 |
| leptonica-recog | ~16,000 | 99/144 (68.8%) | スキュー補正, デワーピング, 文字認識, バーコード |
| その他 | - | 12/116 (10.3%) | ワーパー, エンコーディング |
| **合計** | **~119,500** | **1,128/1,880 (60.0%)** | |

## 未実装の主要領域

### leptonica-core（残り未実装: ~337関数）
...
- [leptonica-filter](comparison/filter.md) — 99関数
