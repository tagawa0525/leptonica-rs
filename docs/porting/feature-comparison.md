...
| ----------------------------------------------------- | --------- | --------- | --------- | ------- | --------- | ---------- | ------------ |
| [leptonica (src/core/)](comparison/core.md)           | 859       | 94        | 116       | 146     | 1,215     | 78.4%      | 89.1%        |
...
| **合計**                                              | **1,786** | **232**   | **132**   | **684** | **2,834** | **71.2%**  | **93.9%**    |
...
| -------------------------- | ------------ | ----------------------- | ----------------------- | ------------------------------------------------------------------------------------ |
| leptonica (src/core/)      | ~47,100      | 953/1,215 (78.4%)       | 953/1,069 (89.1%)       | Pix, Box, Pta, Ptaa, Pixaa, Colormap, 演算, 比較, ブレンド, 描画, 統計, ヒストグラム |
...
| **合計**                   | **~147,000** | **2,018/2,834 (71.2%)** | **2,018/2,150 (93.9%)** |                                                                                      |

## 未実装関数の状況

🚫 不要と分類された 684 関数を除く 2,150 関数のうち 2,018 関数が実装済み（✅ 1,786 + 🔄 232）。
残り 132 関数（❌）は未実装。実カバレッジは 93.9%。
