...
| ----------------------------------------------------- | --------- | --------- | --------- | ------- | --------- | ---------- | ------------ |
| [leptonica (src/core/)](comparison/core.md)           | 848       | 76        | 177       | 114     | 1,215     | 76.0%      | 83.9%        |
| [leptonica (src/io/)](comparison/io.md)               | 139       | 19        | 5         | 45      | 208       | 76.0%      | 96.9%        |
| [leptonica (src/transform/)](comparison/transform.md) | 109       | 19        | 0         | 14      | 142       | 90.1%      | 100.0%       |
| [leptonica (src/morph/)](comparison/morph.md)         | 116       | 22        | 8         | 25      | 171       | 80.7%      | 94.5%        |
...
| [その他](comparison/misc.md)                          | 145       | 5         | 71        | 305     | 526       | 28.5%      | 67.9%        |
| **合計**                                              | **1,768** | **214**   | **279**   | **573** | **2,834** | **69.9%**  | **87.7%**    |
...
| -------------------------- | ------------ | ----------------------- | ----------------------- | ------------------------------------------------------------------------------------ |
| leptonica (src/core/)      | ~47,100      | 924/1,215 (76.0%)       | 924/1,101 (83.9%)       | Pix, Box, Pta, Ptaa, Pixaa, Colormap, 演算, 比較, ブレンド, 描画, 統計, ヒストグラム |
| leptonica (src/io/)        | ~7,900       | 158/208 (76.0%)         | 158/163 (96.9%)         | BMP/PNG/JPEG/PNM/TIFF/GIF/WebP/JP2K/PDF/PS/SPIX + ヘッダー読み取り                   |
| leptonica (src/transform/) | ~11,200      | 128/142 (90.1%)         | 128/128 (100.0%)        | 回転, スケーリング, アフィン, 射影, シアー                                           |
| leptonica (src/morph/)     | ~9,400       | 138/171 (80.7%)         | 138/146 (94.5%)         | 二値/グレースケール/カラー形態学, DWA, 細線化                                        |
...
| その他                     | -            | 150/526 (28.5%)         | 150/221 (67.9%)         | ワーパー, エンコーディング, デバッグ/タイミング系等                                  |
| **合計**                   | **~147,000** | **1,982/2,834 (69.9%)** | **1,982/2,261 (87.7%)** |                                                                                      |

## 未実装関数の状況

🚫 不要と分類された 573 関数を除く 2,261 関数のうち 1,982 関数が実装済み（✅ 1,768 + 🔄 214）。
残り 279 関数（❌）は未実装。実カバレッジは 87.7%。
