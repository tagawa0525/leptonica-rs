...
| ----------------------------------------------------- | --------- | --------- | --------- | ------- | --------- | ---------- | ------------ |
| [leptonica (src/core/)](comparison/core.md)           | 887       | 46        | 153       | 129     | 1,215     | 76.8%      | 85.9%        |
...
| [leptonica (src/filter/)](comparison/filter.md)       | 107       | 0         | 5         | 13      | 125       | 85.6%      | 95.5%        |
...
| [その他](comparison/misc.md)                          | 149       | 5         | 64        | 314     | 532       | 28.9%      | 70.6%        |
| **合計**                                              | **1,806** | **184**   | **247**   | **597** | **2,834** | **70.2%**  | **88.9%**    |
...
| -------------------------- | ------------ | ----------------------- | ----------------------- | ------------------------------------------------------------------------------------ |
| leptonica (src/core/)      | ~47,100      | 933/1,215 (76.8%)       | 933/1,086 (85.9%)       | Pix, Box, Pta, Ptaa, Pixaa, Colormap, 演算, 比較, ブレンド, 描画, 統計, ヒストグラム |
...
| leptonica (src/filter/)    | ~9,800       | 107/125 (85.6%)         | 107/112 (95.5%)         | 畳み込み, エッジ検出, バイラテラル, ランク, 適応マッピング                           |
...
| その他                     | -            | 154/532 (28.9%)         | 154/218 (70.6%)         | ワーパー, エンコーディング, デバッグ/タイミング系等                                  |
| **合計**                   | **~147,000** | **1,990/2,834 (70.2%)** | **1,990/2,237 (88.9%)** |                                                                                      |

## 未実装関数の状況

🚫 不要と分類された 597 関数を除く 2,237 関数のうち 1,990 関数が実装済み（✅ 1,806 + 🔄 184）。
残り 247 関数（❌）は未実装。実カバレッジは 88.9%。

なお、本数値は `gap-fill audit 2026-05-10` で `allheaders.h` の C 公開関数 2,743 件全てを
洗い出した結果であり、それ以前 (2,286 件ベース) の集計から大きく更新されている。
