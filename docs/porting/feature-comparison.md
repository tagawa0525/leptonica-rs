...
| ----------------------------------------------------- | --------- | --------- | --------- | ------- | --------- | ---------- | ------------ |
| [leptonica (src/core/)](comparison/core.md)           | 855       | 93        | 121       | 146     | 1,215     | 78.0%      | 88.7%        |
...
| **合計**                                              | **1,782** | **231**   | **137**   | **684** | **2,834** | **71.1%**  | **93.6%**    |
...
| -------------------------- | ------------ | ----------------------- | ----------------------- | ------------------------------------------------------------------------------------ |
| leptonica (src/core/)      | ~47,100      | 948/1,215 (78.0%)       | 948/1,069 (88.7%)       | Pix, Box, Pta, Ptaa, Pixaa, Colormap, 演算, 比較, ブレンド, 描画, 統計, ヒストグラム |
...
| **合計**                   | **~147,000** | **2,013/2,834 (71.1%)** | **2,013/2,150 (93.6%)** |                                                                                      |

## 未実装関数の状況

🚫 不要と分類された 684 関数を除く 2,150 関数のうち 2,013 関数が実装済み（✅ 1,782 + 🔄 231）。
残り 137 関数（❌）は未実装。実カバレッジは 93.6%。
