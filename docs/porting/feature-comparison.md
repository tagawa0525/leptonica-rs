...
| ----------------------------------------------------- | --------- | --------- | --------- | ------- | --------- | ---------- | ------------ |
| [leptonica (src/core/)](comparison/core.md)           | 848       | 93        | 128       | 146     | 1,215     | 77.4%      | 88.0%        |
...
| [leptonica (src/filter/)](comparison/filter.md)       | 112       | 0         | 6         | 13      | 131       | 85.5%      | 94.9%        |
...
| [leptonica (src/recog/)](comparison/recog.md)         | 132       | 45        | 12        | 18      | 207       | 85.5%      | 93.7%        |
| [その他](comparison/misc.md)                          | 145       | 5         | 5         | 371     | 526       | 28.5%      | 96.8%        |
| **合計**                                              | **1,768** | **231**   | **151**   | **684** | **2,834** | **70.5%**  | **93.0%**    |
...
| -------------------------- | ------------ | ----------------------- | ----------------------- | ------------------------------------------------------------------------------------ |
| leptonica (src/core/)      | ~47,100      | 941/1,215 (77.4%)       | 941/1,069 (88.0%)       | Pix, Box, Pta, Ptaa, Pixaa, Colormap, 演算, 比較, ブレンド, 描画, 統計, ヒストグラム |
...
| leptonica (src/filter/)    | ~9,800       | 112/131 (85.5%)         | 112/118 (94.9%)         | 畳み込み, エッジ検出, バイラテラル, ランク, 適応マッピング, ランレングス             |
...
| leptonica (src/recog/)     | ~16,000      | 177/207 (85.5%)         | 177/189 (93.7%)         | スキュー補正, デワーピング, 文字認識, バーコード                                     |
| その他                     | -            | 150/526 (28.5%)         | 150/155 (96.8%)         | ワーパー, エンコーディング, デバッグ/タイミング系等                                  |
| **合計**                   | **~147,000** | **1,999/2,834 (70.5%)** | **1,999/2,150 (93.0%)** |                                                                                      |

## 未実装関数の状況

🚫 不要と分類された 684 関数を除く 2,150 関数のうち 1,999 関数が実装済み（✅ 1,768 + 🔄 231）。
残り 151 関数（❌）は未実装。実カバレッジは 93.0%。

本数値は `gap-fill audit 2026-05-10` で `allheaders.h` の C 公開関数 2,743 件を全数集計し、
さらに各 ✅/🔄/🚫/❌ エントリを C 関数名・C ソースファイル・Rust 実装場所で個別レビューし、
Rust 標準ライブラリで代替可能なファイル/パス/文字列ユーティリティ等を 🚫 に再分類した結果である。
