...
| ----------------------------------------------------- | --------- | --------- | --------- | ------- | --------- | ---------- | ------------ |
| [leptonica (src/core/)](comparison/core.md)           | 769       | 43        | 30        | 77      | 919       | 88.4%      | 96.4%        |
...
| [leptonica (src/filter/)](comparison/filter.md)       | 106       | 0         | 1         | 13      | 120       | 88.3%      | 99.1%        |
...
| [その他](comparison/misc.md)                          | 87        | 5         | 51        | 181     | 324       | 28.4%      | 64.3%        |
| **合計**                                              | **1,587** | **174**   | **113**   | **412** | **2,286** | **77.0%**  | **94.0%**    |
...
| -------------------------- | ------------ | ----------------------- | ------------------------ | ------------------------------------------------------------------------------------ |
| leptonica (src/core/)      | ~47,100      | 812/919 (88.4%)         | 812/842 (96.4%)          | Pix, Box, Pta, Ptaa, Pixaa, Colormap, 演算, 比較, ブレンド, 描画, 統計, ヒストグラム |
...
| leptonica (src/filter/)    | ~9,800       | 106/120 (88.3%)         | 106/107 (99.1%)          | 畳み込み, エッジ検出, バイラテラル, ランク, 適応マッピング                           |
...
| その他                     | -            | 92/324 (28.4%)          | 92/143 (64.3%)           | ワーパー, エンコーディング                                                           |
| **合計**                   | **~144,000** | **1,761/2,286 (77.0%)** | **1,761/1,874 (94.0%)**  |                                                                                      |

## 未実装関数の状況

🚫不要と分類された412関数を除く1,874関数のうち1,761関数が実装済み（✅1,587 + 🔄174、❌113）。
実カバレッジは94.0%。
