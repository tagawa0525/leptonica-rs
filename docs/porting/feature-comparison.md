...
調査日: 2026-02-23（Phase 10-1 blend回帰テスト完了、全10Phase反映）
...
|---------|--------|----------|---------|---------|------|-----------|------------|
| [leptonica (src/core/)](comparison/core.md) | 521 | 24 | 230 | 107 | 882 | 61.8% | 70.3% |
| [leptonica (src/io/)](comparison/io.md) | 88 | 18 | 51 | 45 | 202 | 52.5% | 67.5% |
| [leptonica (src/transform/)](comparison/transform.md) | 88 | 19 | 16 | 14 | 137 | 78.1% | 87.0% |
| [leptonica (src/morph/)](comparison/morph.md) | 82 | 16 | 10 | 27 | 135 | 72.6% | 90.7% |
| [leptonica (src/filter/)](comparison/filter.md) | 100 | 0 | 6 | 11 | 118 | 84.7% | 93.5% |
| [leptonica (src/color/)](comparison/color.md) | 52 | 16 | 45 | 13 | 126 | 54.0% | 60.2% |
| [leptonica (src/region/)](comparison/region.md) | 40 | 8 | 25 | 22 | 95 | 50.5% | 65.8% |
| [leptonica (src/recog/)](comparison/recog.md) | 94 | 26 | 35 | 18 | 173 | 69.4% | 77.4% |
| [その他](comparison/misc.md) | 11 | 0 | 133 | 181 | 325 | 3.4% | 7.6% |
| **合計** | **1,076** | **127** | **551** | **438** | **2,193** | **54.9%** | **68.5%** |
...
| -------- | ---- | ------------- | ----------- | -------- |
| leptonica (src/core/) | ~47,100 | 545/882 (61.8%) | 545/775 (70.3%) | Pix, Box, Pta, Colormap, 演算, 比較, ブレンド, 描画, 統計, ヒストグラム |
| leptonica (src/io/) | ~7,900 | 106/202 (52.5%) | 106/157 (67.5%) | BMP/PNG/JPEG/PNM/TIFF/GIF/WebP/JP2K/PDF/PS/SPIX + ヘッダー読み取り |
| leptonica (src/transform/) | ~11,200 | 107/137 (78.1%) | 107/123 (87.0%) | 回転, スケーリング, アフィン, 射影, シアー |
| leptonica (src/morph/) | ~9,400 | 98/135 (72.6%) | 98/108 (90.7%) | 二値/グレースケール/カラー形態学, DWA, 細線化 |
| leptonica (src/filter/) | ~9,800 | 100/118 (84.7%) | 100/107 (93.5%) | 畳み込み, エッジ検出, バイラテラル, ランク, 適応マッピング |
| leptonica (src/color/) | ~7,400 | 68/126 (54.0%) | 68/113 (60.2%) | 色空間変換, 量子化, セグメンテーション, 二値化, 色分析 |
| leptonica (src/region/) | ~10,600 | 48/95 (50.5%) | 48/73 (65.8%) | 連結成分, シードフィル, 分水嶺, 四分木, 迷路 |
| leptonica (src/recog/) | ~16,000 | 120/173 (69.4%) | 120/155 (77.4%) | スキュー補正, デワーピング, 文字認識, バーコード |
| その他 | - | 11/325 (3.4%) | 11/144 (7.6%) | ワーパー, エンコーディング |
| **合計** | **~119,500** | **1,203/2,193 (54.9%)** | **1,203/1,755 (68.5%)** | |

## 未実装の主要領域（❌ 551関数）

438関数は🚫不要と分類済み。残りの❌未実装551関数の内訳:

### leptonica (src/core/)（❌ 230関数）

Phase 13-17で大幅に改善。残りの主な未実装領域:
...
- **PDF応用** (pdfapp.c): 複数画像PDF生成
- **テキスト描画・境界** (textops.c): テキスト追加・境界追加/除去
- **ビットマップフォント** (bmf.c): フォント管理
- **グラフ描画** (gplot.c): gnuplot連携グラフ生成
- **線幅操作** (strokes.c): 線幅検出・変更
- **ランレングス変換** (runlength.c)
- **各種検出・変換**: partition.c, partify.c, checkerboard.c, convertfiles.c, finditalic.c

### leptonica (src/io/)（❌ 51関数）

- **PDF生成**: 単一画像・複数画像PDF生成の高レベルAPI
- **マルチページTIFF**: 追加的なTIFF操作

### leptonica (src/color/)（❌ 45関数）

- **FPIXA依存**: 色空間変換のFPixa版
- **カラーマップ操作**: HSV/ヒストグラム/ブレンド等

### leptonica (src/recog/)（❌ 35関数）

- **ページセグメンテーション**: テーブル検出等の高度な機能（classapp.c含む）
- **デワーピング**: Dewarpa多ページ管理

### leptonica (src/region/)（❌ 25関数）
...
- [leptonica (src/core/)](comparison/core.md) — 882関数（🚫107不要）
- [leptonica (src/io/)](comparison/io.md) — 202関数（🚫45不要）
- [leptonica (src/transform/)](comparison/transform.md) — 137関数（🚫14不要）
- [leptonica (src/morph/)](comparison/morph.md) — 135関数（🚫27不要）
- [leptonica (src/filter/)](comparison/filter.md) — 118関数（🚫11不要）
- [leptonica (src/color/)](comparison/color.md) — 126関数（🚫13不要）
- [leptonica (src/region/)](comparison/region.md) — 95関数（🚫22不要）
- [leptonica (src/recog/)](comparison/recog.md) — 173関数（🚫18不要）
- [その他](comparison/misc.md) — 325関数（🚫181不要）
