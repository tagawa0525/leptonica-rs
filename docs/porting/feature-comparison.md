...
|---------|--------|----------|---------|------|-----------|
| [leptonica (src/core/)](comparison/core.md) | 521 | 24 | 337 | 882 | 61.8% |
| [leptonica (src/io/)](comparison/io.md) | 68 | 17 | 61 | 146 | 58.2% |
| [leptonica (src/transform/)](comparison/transform.md) | 82 | 9 | 61 | 152 | 59.9% |
| [leptonica (src/morph/)](comparison/morph.md) | 82 | 16 | 22 | 120 | 81.7% |
| [leptonica (src/filter/)](comparison/filter.md) | 82 | 0 | 17 | 99 | 82.8% |
| [leptonica (src/color/)](comparison/color.md) | 52 | 16 | 58 | 126 | 54.0% |
| [leptonica (src/region/)](comparison/region.md) | 40 | 8 | 47 | 95 | 50.5% |
| [leptonica (src/recog/)](comparison/recog.md) | 83 | 16 | 45 | 144 | 68.8% |
...
| -------- | ---- | ------------- | -------- |
| leptonica (src/core/) | ~47,100 | 545/882 (61.8%) | Pix, Box, Pta, Colormap, 演算, 比較, ブレンド, 描画, 統計, ヒストグラム |
| leptonica (src/io/) | ~7,900 | 85/146 (58.2%) | BMP/PNG/JPEG/PNM/TIFF/GIF/WebP/JP2K/PDF/PS/SPIX + ヘッダー読み取り |
| leptonica (src/transform/) | ~11,200 | 91/152 (59.9%) | 回転, スケーリング, アフィン, 射影, シアー |
| leptonica (src/morph/) | ~9,400 | 98/120 (81.7%) | 二値/グレースケール/カラー形態学, DWA, 細線化 |
| leptonica (src/filter/) | ~9,800 | 82/99 (82.8%) | 畳み込み, エッジ検出, バイラテラル, ランク, 適応マッピング |
| leptonica (src/color/) | ~7,400 | 68/126 (54.0%) | 色空間変換, 量子化, セグメンテーション, 二値化, 色分析 |
| leptonica (src/region/) | ~10,600 | 48/95 (50.5%) | 連結成分, シードフィル, 分水嶺, 四分木, 迷路 |
| leptonica (src/recog/) | ~16,000 | 99/144 (68.8%) | スキュー補正, デワーピング, 文字認識, バーコード |
| その他 | - | 12/116 (10.3%) | ワーパー, エンコーディング |
| **合計** | **~119,500** | **1,128/1,880 (60.0%)** | |

## 未実装の主要領域

### leptonica (src/core/)（残り未実装: ~337関数）

Phase 13-17で大幅に改善（26.7% → 61.8%）。残りの主な未実装領域:
...
### leptonica (src/filter/)（カバレッジ: 82.8%）
...
- [leptonica (src/core/)](comparison/core.md) — 882関数
- [leptonica (src/io/)](comparison/io.md) — 146関数
- [leptonica (src/transform/)](comparison/transform.md) — 152関数
- [leptonica (src/morph/)](comparison/morph.md) — 120関数
- [leptonica (src/filter/)](comparison/filter.md) — 99関数
- [leptonica (src/color/)](comparison/color.md) — 126関数
- [leptonica (src/region/)](comparison/region.md) — 95関数
- [leptonica (src/recog/)](comparison/recog.md) — 144関数
