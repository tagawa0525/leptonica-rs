...
調査日: 2026-02-23（全関数カバレッジ実装完了を反映）
...
|---------|--------|----------|---------|---------|------|-----------|------------|
| [leptonica (src/core/)](comparison/core.md) | 751 | 24 | 0 | 107 | 882 | 87.9% | 100.0% |
...
| [leptonica (src/morph/)](comparison/morph.md) | 92 | 16 | 0 | 27 | 135 | 80.0% | 100.0% |
| [leptonica (src/filter/)](comparison/filter.md) | 106 | 0 | 0 | 12 | 118 | 89.8% | 100.0% |
| [leptonica (src/color/)](comparison/color.md) | 97 | 16 | 0 | 13 | 126 | 89.7% | 100.0% |
| [leptonica (src/region/)](comparison/region.md) | 65 | 8 | 0 | 22 | 95 | 76.8% | 100.0% |
| [leptonica (src/recog/)](comparison/recog.md) | 129 | 26 | 0 | 18 | 173 | 89.6% | 100.0% |
| [その他](comparison/misc.md) | 144 | 0 | 0 | 181 | 325 | 44.3% | 100.0% |
| **合計** | **1,627** | **127** | **0** | **439** | **2,193** | **80.0%** | **100.0%** |
...
| -------- | ---- | ------------- | ----------- | -------- |
| leptonica (src/core/) | ~47,100 | 775/882 (87.9%) | 775/775 (100.0%) | Pix, Box, Pta, Colormap, 演算, 比較, ブレンド, 描画, 統計, ヒストグラム |
...
| leptonica (src/morph/) | ~9,400 | 108/135 (80.0%) | 108/108 (100.0%) | 二値/グレースケール/カラー形態学, DWA, 細線化 |
| leptonica (src/filter/) | ~9,800 | 106/118 (89.8%) | 106/106 (100.0%) | 畳み込み, エッジ検出, バイラテラル, ランク, 適応マッピング |
| leptonica (src/color/) | ~7,400 | 113/126 (89.7%) | 113/113 (100.0%) | 色空間変換, 量子化, セグメンテーション, 二値化, 色分析 |
| leptonica (src/region/) | ~10,600 | 73/95 (76.8%) | 73/73 (100.0%) | 連結成分, シードフィル, 分水嶺, 四分木, 迷路 |
| leptonica (src/recog/) | ~16,000 | 155/173 (89.6%) | 155/155 (100.0%) | スキュー補正, デワーピング, 文字認識, バーコード |
| その他 | - | 144/325 (44.3%) | 144/144 (100.0%) | ワーパー, エンコーディング |
| **合計** | **~119,500** | **1,754/2,193 (80.0%)** | **1,754/1,754 (100.0%)** | |

## 全関数カバレッジ達成

🚫不要と分類された439関数を除く全1,754関数（✅1,627 + 🔄127）が実装済み。
❌未実装は0関数となり、実カバレッジ100%を達成した。
...
- [leptonica (src/filter/)](comparison/filter.md) — 118関数（🚫12不要）
