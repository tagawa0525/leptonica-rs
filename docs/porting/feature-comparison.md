...
| [leptonica (src/transform/)](comparison/transform.md) | 107       | 19        | 0         | 14      | 140       | 90.0%      | 100.0%       |
...
| [その他](comparison/misc.md)                          | 144       | 0         | 0         | 176     | 320       | 45.0%      | 100.0%       |
| **合計**                                              | **1,711** | **133**   | **0**     | **402** | **2,246** | **82.1%**  | **100.0%**   |
...
| **合計**                   | **~144,000** | **1,844/2,246 (82.1%)** | **1,844/1,844 (100.0%)** |                                                                                      |

## 未実装関数の状況

🚫不要と分類された402関数を除く1,844関数の全てが実装済み（✅1,711 + 🔄133）。
実カバレッジは100.0%。
