...
| [leptonica (src/morph/)](comparison/morph.md)         | 110       | 19        | 9         | 25      | 163       | 79.1%      | 93.5%        |
...
| **合計**                                              | **1,650** | **177**   | **47**    | **412** | **2,286** | **79.9%**  | **97.5%**    |
...
| leptonica (src/morph/)     | ~9,400       | 129/163 (79.1%)         | 129/138 (93.5%)          | 二値/グレースケール/カラー形態学, DWA, 細線化                                        |
...
| **合計**                   | **~144,000** | **1,827/2,286 (79.9%)** | **1,827/1,874 (97.5%)**  |                                                                                      |

## 未実装関数の状況

🚫不要と分類された412関数を除く1,874関数のうち1,827関数が実装済み（✅1,650 + 🔄177、❌47）。
実カバレッジは97.5%。
